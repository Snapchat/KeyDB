...
public:
    ...
    virtual std::vector<std::string> getExpirationCandidates(int) override { return std::vector<std::string>(); }
    virtual std::vector<std::string> getEvictionCandidates(int) override { return std::vector<std::string>(); }
